...
\begin{align*}
	\mathcal{L}\{F_T(x)\} &= \int_0^\infty e^{-sx} F_T(x) dx \\
		&= \int_0^\infty e^{-sx} \left( 1 - e^{-\frac{x + a^2x^2/2}{\eta}} \right) dx \\
		&= \int_0^\infty e^{-sx} dx - \int_0^\infty e^{-sx} e^{-\frac{x + a^2x^2/2}{\eta}} dx \\
		&= \frac{1}{s} - \int_0^\infty e^{-sx -\frac{x + a^2x^2/2}{\eta}} dx \\
\end{align*}

Let $b=\frac{a}{\sqrt(2 \eta)}$ and $c = \frac{\sqrt(2 \eta)}{2a} \left( s + \frac{1}{\eta} \right)$, then $sx + \frac{x+a^2x^2/2}{\eta} = (bx + c)^2 - c^2$.
Let $y = bx+c \Rightarrow dy = bdx$.

\begin{align*}
	\int_0^\infty e^{-sx -\frac{x + a^2x^2/2}{\eta}} dx &= \int_0^\infty e^{-(bx+c)^2 + c^2} dx \\
...
As $\frac{d}{ds}c = \frac{\sqrt{2 \eta}}{2a}$,

\begin{align*}
\frac{d}{ds} T^*(s) &= - \frac{\sqrt{\pi}e^{c^2}}{2b} \erfc(c) - \frac{\sqrt{2 \eta \pi} sc e^{c^2}}{2ab} \erfc(c) + \frac{\sqrt{2 \eta \pi}s}{4ab} \\
\frac{d}{ds} T^*(s)|_{s=0} &= - \frac{\sqrt{2 \eta \pi}}{2a} e^{\frac{1}{2 \eta a^2}} \erfc\left(\frac{1}{a \sqrt{2 \eta}}\right) \\
\mathbf{E}[T] &= \frac{\sqrt{2 \eta \pi}}{2a} e^{\frac{1}{2 \eta a^2}} \erfc\left(\frac{1}{a \sqrt{2 \eta}}\right) \\
\end{align*}
