...
\begin{figure}[ht]
\centering\includegraphics[height=5cm]{./images01/time-6-blocks.pdf}
...
It is easy to notice that $lim_{a \rightarrow 0} \mathbf{E}[T] = \tau = 600$, and $lim_{a \rightarrow \infty} \mathbf{E}[T] = 0$.
