...
\chapter{Results (iv): Supervised classification application}
...
\chapter{Results (iii): Supervised image noise filtering application}
...
\chapter{Results (v): The possibility of unsupervised reinforcement learning}
