...
The idea behind these reward bitstrings is to increase the score of positive rewards (all bits set to 1), and to decrease the score of negative rewards (all bits set to 0). The neutral reward will have, on average, half of its bits 1 and the other half 0. Thus, it is in the middle between a positive reward and a negative reward.
...
\begin{figure}[!htb]
\centering
\subfloat[Loses over time]{\includegraphics[width=\textwidth]{./images02/ttt/results-random-loses.png}}
...
\begin{figure}[!htb]
\centering
\subfloat[Loses over time]{\includegraphics[width=\textwidth]{./images02/ttt/results-smart-loses.png}}
...
\begin{figure}[!htb]
\centering
\subfloat[Loses over time]{\includegraphics[width=\textwidth]{./images02/ttt/results-sdm-loses.png}}
...
\begin{figure}[!htb]
\centering
\subfloat[Loses over time]{\includegraphics[width=\textwidth]{./images02/ttt/results-mixed-loses.png}}
