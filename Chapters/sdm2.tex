...
%FOOTNOTE:
The graph composed of $\{0,1\}^n$ nodes and links between nodes $iff$ their Hamming distance is one is called the \emph{hypercube graph}, or $Q_n$.  It is a beautiful combinatorial object on its own for which one can find a survey in \citet{harary1988survey}.
