...
\begin{figure}[h]
\centering\includegraphics[scale=0.75]{images03/p_circle_r.pdf}
...
\begin{figure}[h]
\centering\includegraphics[scale=0.75]{images03/p1_inter_p2.pdf}
...
\begin{figure}[h]
\centering\includegraphics[scale=0.75]{images03/hardlocations.pdf}
...
\begin{figure}[h]
\centering\includegraphics[scale=0.75]{images03/p1_p2_iter_read.pdf}
...
\begin{figure}[h]
\centering\includegraphics[scale=0.75]{images03/p1_after_write.pdf}
