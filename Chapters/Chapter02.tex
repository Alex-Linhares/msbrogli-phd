...
Consider the implementations of SDM present --- as of this writing --- on its wikipedia entry:
...
The main contribution of this work is a reference implementation which yields (i) orders of magnitude gains in performance, (ii) has several backends and operations, (iii) has been validated against the mathematical model, (iv) is cross-platform, and (v) is easily extensible to test new research ideas.
