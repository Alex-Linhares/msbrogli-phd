...
Psychological
miller magic number; when it instantly remembers; when it doesn't recall anything at all; when tip-of-the-tongue... how does this recall process work?
...
Computational (fully experimental, with no voodoo-like mysterious properties)
...
\begin{enumerate}
    ...
    \item a 2013 Java implementation `Learning Intelligent Distribution Agent' (LIDA) developed by \citep{franklin_lida:_2014, snaider_integer_2013, snaider_modular_2014} Stan Franklin from the University of Memphis includes implementation. \footnote{http://ccrg.cs.memphis.edu/framework.html};
