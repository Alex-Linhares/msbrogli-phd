...
<<<<<<< HEAD
In this chapter we will explore how the generalized read operation works and whether it may improve SDM behavior or not. In this case, we are specifically interested into the impact in the critical distance. An increase in , which means it is able to recognize things with even less clues than before.
=======
...
>>>>>>> 33f007965c4cd8e6a41989ecfed9fb02fb364633
