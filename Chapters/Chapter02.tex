...
Let us compare this to what a child might do.
...
% Post-defense TODO: Use the robustness of neurons as a guide.  A more quantitative study of this loss of neurons... between d=0 and d=critical_distance
% Post-defense TODO: magic numbers
% Post-defense TODO: mu - m sigma, in which the expected number of neurons is, say, 256 (instead of >1000).
% Post-defense TODO: study this.  The marginal increase of 10% of Hard locations increases by how many percentage points the critical distance? In fact, is there a way to study this algebrically?  That would be so cool!
...
highway hypnosis; absentminded driving; Going on Autopilot; PNAS study
...
% TODO include persian and russian back, through inkscape pdf
% https://tex.stackexchange.com/a/370073/33832
\end{table}\label{table:lflashing}

% TODO look at previous paper on this and speculate it here in SDM, somewhere
% TODO include on book from the following:
%
...
% https://books.google.com.br/books?id=OURuAAAAMAAJ&q=%22life+flashed+before+his+eyes%22+subject:%22History%22&dq=%22life+flashed+before+his+eyes%22+subject:%22History%22&hl=en&sa=X&ved=0ahUKEwjdr9aiu7faAhWHvJAKHdlGC7IQ6AEIXDAJ

% https://www.amazon.com/gp/offer-listing/044021310X/ref=olp_page_1?ie=UTF8&f_all=true
%
...
% Post-Defense TODO:  SDM creating Voronoi Tesselations of concepts, with different sized areas for each.  This should solve i versus l.
...
\caption{Desiderata of open-source, creative-common deliverables, longer-term.  Some of these items are mature for wide dissemination, whereas others are in planning phase.  For an online SDM course, for instance, we might partner with a Ph.D. program in the Teaching of Mathematics and Physics, such as \citet{im/ufrj_programa_nodate}.}
