...
A second and final qualification: It is my hope that readers of this thesis will accept the format of self-contained studies, as just as valid as a monograph on a particular topic\footnote{e.g., a reference to the ``fundamental research theorem'', reprinted in the Appendix, seems inescapable.}.  With these qualifications, we are ready to venture into the world of computational management science.
