...
So far we have looked only at a single dimension.  Let us think about how the entire bitstring is affected by this result.
...
\begin{figure}[h!]
  ...
  \caption{The histogram was obtained through simulation. The red curve is the theoretical normal distribution found in \ref{T2}.}
