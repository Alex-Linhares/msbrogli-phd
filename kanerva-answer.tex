...
Kanerva writes\footnote{Email thread `SDM: A puzzling issue and an invitation', started March 16th 2018, in which we discussed the aforementioned discrepancy.  Some centuries ago, dear reader, all scientific publishing was the exchange of such letters...}:
...
\begin{align}
\mu_1 &= p \theta \\
\sigma_1^2 &= p(1-p) \theta + p^2 s^2 p_1 (1 - p_1) / H
\end{align}
