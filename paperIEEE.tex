...
Replace this box by an image with a width of 1\,in and a height of
1.25\,in!%
\end{minipage}}}]{Alexandre Linhares} received the Ph.D. degree from the National Institute of Space Research, 2001. He is an Associate Professor at the Center of Behavioral Research, EBAPE / Getulio Vargas Foundation.  He has published circa 30 papers in journals such as \emph{Artificial Intelligence, Biological Cybernetics, Cognitive Science, IEEE Transactions on Evolutionary Computation, Information Sciences, Frontiers in Psychology,} etc.
\end{IEEEbiography}
