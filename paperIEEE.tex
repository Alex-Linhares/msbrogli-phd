...
\caption{A planar projection of the space illustrates some of the mechanisms.  Activated addresses inside access radius $r$ around the center address.\label{fig-addresses-inside-access-radius}}
\end{figure}
...
It was previously believed that reading at a distance $d=n/2$ would retrieve items at the equator distance, but this is not necessarily true. We have shown the subtle, but previously unnoticed, effect of autocorrelation in sparse distributed memory.  We have also derived excellent analytical approximations of the system's behavior. In this concluding section, some comments i) on the implications of this work, on ii) Future research, and iii) on the availability of the code are offered.
...
Our conclusion is that this work is of special relevance as it brings about some \emph{systemwide properties} that models need to take into account.  The first decision choice involved in building a system with SDM regards the size of $n$, the number of dimensions of the memory.  Here, complementing the work of \cite{sjodin_improving_1995, sjodin_convergence_1998} in Jaeckel's SDM design \cite{jaeckel1989class}, we show that as $n$ grows, autocorrelation tends to $0$.  But recall that as $n$ grows, the size of the critical distance also tends to $0$.  It is therefore crucial to select a value for $n$ in which the model will retain its convergence properties, with the understanding of the possible effects brought about by autocorrelation.   Systemwide properties such as these affect the entire behavior of the model and, as such, should always be taken into account by theoreticians and modelers alike.
...
\begin{figure}[ht!]
  ...
  \subfloat[Bongard problem 71]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp071.png}}

  \subfloat[Bongard problem 72]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp072.png}}

  \subfloat[Bongard problem 73]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp073.png}}

  \subfloat[Bongard problem 74]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp074.png}}

%  \subfloat[Bongard problem 75]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp075.png}}

%  \subfloat[Bongard problem 76]{\includegraphics[width=0.35\textwidth]{./images02/Bongard-problemp076.png}}

  \caption{Bongard problems 71 - 74, courtesy of Dr. Harry Foundalis\cite{foundalis_phaeaco:_2006, douglas1980godel, bongard_recognition_1968, Linhares2000}.  What distinguishes the boxes on the left hand side to those on the right hand side?  This is the quintessential `system-2' type of problem that current lies beyond AI's capabilities. The reader should note that here, for each class, $n=6$: a hard task for Machine Learning.}
...
of the immense power of Artificial Intelligence.
